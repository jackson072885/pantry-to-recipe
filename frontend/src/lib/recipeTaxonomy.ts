...
export const CANONICAL_INGREDIENTS = [
  ...
  { id: "steak", label: "steak", categoryId: "proteins", subcategoryId: "red_meat", aliases: [], browseNodeIds: ["beef"], recommendationRollupIds: ["beef"], visibility: "browse_and_search" },
  ...
  { id: "white_fish", label: "white fish", categoryId: "proteins", subcategoryId: "seafood", aliases: ["whitefish"], browseNodeIds: ["seafood"], recommendationRollupIds: ["seafood"], visibility: "browse_and_search" },
  ...
  { id: "pasta", label: "pasta", categoryId: "grains_starches", subcategoryId: "pasta_noodles", aliases: ["macaroni", "penne", "linguine", "fettuccine", "shells"], browseNodeIds: ["pasta_noodles"], recommendationRollupIds: ["grains_starches"], visibility: "browse_and_search" },
  ...
  { id: "noodles", label: "noodles", categoryId: "grains_starches", subcategoryId: "pasta_noodles", aliases: ["egg noodles"], browseNodeIds: ["pasta_noodles"], recommendationRollupIds: ["grains_starches"], visibility: "browse_and_search" },
  ...
  { id: "breadcrumbs", label: "breadcrumbs", categoryId: "grains_starches", subcategoryId: "bread_wraps", aliases: ["bread crumbs"], browseNodeIds: ["bread_wraps"], recommendationRollupIds: ["grains_starches"], visibility: "browse_and_search" },
  ...
  { id: "cream", label: "cream", categoryId: "dairy_creamy", subcategoryId: "milk_cream", aliases: ["heavy cream", "half-and-half", "half and half"], browseNodeIds: ["milk_cream"], recommendationRollupIds: ["dairy_creamy"], visibility: "browse_and_search" },
  ...
  { id: "vinegar", label: "vinegar", categoryId: "sauces_condiments", subcategoryId: "oils_fats", aliases: [], browseNodeIds: ["oils_fats"], recommendationRollupIds: ["oils_fats"], visibility: "browse_and_search" },
