...
export const CANONICAL_INGREDIENTS = [
  ...
  { id: "noodles", label: "noodles", categoryId: "grains_starches", subcategoryId: "pasta_noodles", aliases: ["egg noodles", "udon", "lo mein", "lo mein noodles", "rice noodles"], browseNodeIds: ["pasta_noodles"], recommendationRollupIds: ["grains_starches"], visibility: "browse_and_search" },
