...
export const CANONICAL_INGREDIENTS = [
  ...
  { id: "steak", label: "steak", categoryId: "proteins", subcategoryId: "red_meat", aliases: ["beef steak", "beef strips", "steak strips", "sliced steak", "thinly sliced steak"], browseNodeIds: ["beef"], recommendationRollupIds: ["beef"], visibility: "browse_and_search" },
  ...
  { id: "vegetable_broth", label: "vegetable broth", categoryId: "sauces_condiments", subcategoryId: "sauces", aliases: ["vegetable stock"], browseNodeIds: ["sauces"], recommendationRollupIds: ["sauces_condiments"], visibility: "search_only" },
